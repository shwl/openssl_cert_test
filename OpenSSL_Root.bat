...
rem 生成私玥;
openssl genrsa -aes256 -passout pass:111111 -out cert\root_rsa_private.key 4096

rem 生成签名证书;
openssl req -utf8 -new -x509 -days 18250 -key cert\root_rsa_private.key -passin pass:111111 -out cert\root_cert.crt -sha256 -config root.cnf -set_serial 0x248b483912a34da1f435da00
